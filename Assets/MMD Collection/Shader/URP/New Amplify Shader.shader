...
Shader "New Amplify Shader"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 URPDecodeInstruction19_g1(  )
			{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float2 texCoord2_g1 = input.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 vertexToFrag10_g1 = ( ( texCoord2_g1 * (unity_LightmapST).xy ) + (unity_LightmapST).zw );
				output.ase_texcoord3.xy = vertexToFrag10_g1;
						 ...
						 ) : SV_Target
			{
				...
				float2 vertexToFrag10_g1 = input.ase_texcoord3.xy;
				float2 UV11_g1 = vertexToFrag10_g1;
				float4 localSampleLightmapHD11_g1 = SampleLightmapHD11_g1( UV11_g1 );
				float4 localURPDecodeInstruction19_g1 = URPDecodeInstruction19_g1();
				float3 decodeLightMap6_g1 = DecodeLightmap(localSampleLightmapHD11_g1,localURPDecodeInstruction19_g1);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( decodeLightMap6_g1 * GetCurrentExposureMultiplier() );
				float Alpha = 1;
...
/*ASEBEGIN
Version=19907
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;13;-384,-32;Inherit;False;FetchLightmapValue;0;;1;43de3d4ae59f645418fdd020d1b8e78e;1,23,1;0;1;FLOAT3;0
...
ASEEND*/
//CHKSM=35C0CF17CBBD3EA4ABF8437AB510F9D323535D21