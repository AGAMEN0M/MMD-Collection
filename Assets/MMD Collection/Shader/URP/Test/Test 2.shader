...
Shader "Test 2"
{
	Properties
	{
		...
		_AlphaClip1( "Alpha Clip", Float ) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float3 vertexValue = ( Status23_g61294 == (float)0 ? temp_cast_1 : ( _EdgeSize * input.normalOS ) );
			...
			) : SV_Target
			{
				...
				float Alpha_Clip_Threshold323 = ( _AlphaClip1 == (float)1 ? _Cutoff : 0.0001 );
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 objToWorldDir5_g61280 = mul( GetObjectToWorldMatrix(), float4( input.ase_normal, 0.0 ) ).xyz;
				float3 normalizeResult3_g61280 = normalize( objToWorldDir5_g61280 );
				float3 normalizeResult2_g61280 = normalize( _MainLightPosition.xyz );
				float dotResult4_g61280 = dot( normalizeResult3_g61280 , normalizeResult2_g61280 );
				float temp_output_1_0_g61284 = ( ( break10_g61284.y * dotResult4_g61280 ) + break10_g61284.z );
				float localshadowAtten16_g61284 = ( 0.0 );
				float3 objToWorld8_g61284 = mul( GetObjectToWorldMatrix(), float4( input.ase_texcoord3.xyz, 1 ) ).xyz;
				...
				float temp_output_3_0_g61281 = ( temp_output_555_22 * 2.0 );
				float4 lerpResult9_g61293 = lerp( tex2DNode33_g61293 , float4( float3( 1, 1, 1 ) , 0.0 ) , saturate( ( ( temp_output_3_0_g61281 * temp_output_3_0_g61281 ) - 1.0 ) ));
				...
				float3 temp_output_12_0_g61282 = OutputColor15_g61284;
				float3 temp_cast_6 = 0;
				float locallightmapCol11_g61282 = ( 0.0 );
				float2 lightmapUV11_g61282 = (input.ase_texcoord4.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float3 Output11_g61282 = float3( 0,0,0 );
				lightmapCol_float( lightmapUV11_g61282 , Output11_g61282 );
				#ifdef LIGHTMAP_ON
				float3 staticSwitch8_g61282 = ( ( temp_output_12_0_g61282 == temp_cast_6 ? ( Output11_g61282 * 2.0 ) : temp_output_12_0_g61282 ) + Output11_g61282 );
				#else
				float3 staticSwitch8_g61282 = temp_output_12_0_g61282;
				#endif
				half3 Global_Light_Scale139 = half3( 0.6, 0.6, 0.6 );
				float3 Light_Color25_g61286 = ( staticSwitch8_g61282 * Global_Light_Scale139 );
				int localeffectsControl33_g61277 = ( 0 );
				float Layer289 = _EFFECTS;
				float Effect_Layer13_g61277 = Layer289;
				float Layer33_g61277 = Effect_Layer13_g61277;
				...
				float4 Base33_g61277 = temp_output_18_0_g61277;
				...
				float4 Add33_g61277 = ( temp_output_18_0_g61277 + temp_output_27_0_g61277 );
				float4 temp_output_15_0_g61277 = ( temp_output_27_0_g61277 * Albedo_Texture41_g61277 );
				float4 Multi33_g61277 = ( temp_output_15_0_g61277 * float4( Temp_Diffuse46_g61277 , 0.0 ) );
				int localuvLayer8_g61277 = ( 0 );
				float Layer8_g61277 = (float)_UVLayer;
				float2 uv_SubTex = input.ase_texcoord5.xyz.xy * _SubTex_ST.xy + _SubTex_ST.zw;
				float2 uv08_g61277 = uv_SubTex;
				float2 uv2_SubTex = input.ase_texcoord4.xy * _SubTex_ST.xy + _SubTex_ST.zw;
				float2 uv18_g61277 = uv2_SubTex;
				float2 uv3_SubTex = input.ase_texcoord4.zw * _SubTex_ST.xy + _SubTex_ST.zw;
				float2 uv28_g61277 = uv3_SubTex;
				float2 uv4_SubTex = input.ase_texcoord6.xy * _SubTex_ST.xy + _SubTex_ST.zw;
				float2 uv38_g61277 = uv4_SubTex;
				float2 UV8_g61277 = float2( 0,0 );
				uvLayer_float( Layer8_g61277 , uv08_g61277 , uv18_g61277 , uv28_g61277 , uv38_g61277 , UV8_g61277 );
				float4 tex2DNode10_g61277 = tex2D( _SubTex, UV8_g61277 );
				float4 Sub33_g61277 = ( float4( Temp_Diffuse46_g61277 , 0.0 ) * Albedo_Texture41_g61277 * tex2DNode10_g61277 );
				float4 RGBA33_g61277 = float4( 0,0,0,0 );
				effectsControl_float( Layer33_g61277 , Base33_g61277 , Add33_g61277 , Multi33_g61277 , Sub33_g61277 , RGBA33_g61277 );
				...
				float3 normalizeResult7_g61285 = normalize( ( _MainLightPosition.xyz + ViewDirWS ) );
				float dotResult1_g61285 = dot( normalizeResult4_g61285 , normalizeResult7_g61285 );
				float localeffectsControl28_g61277 = ( 0.0 );
				float Layer28_g61277 = Effect_Layer13_g61277;
				float4 Base28_g61277 = Albedo_Texture41_g61277;
				float4 Add28_g61277 = ( temp_output_27_0_g61277 + Albedo_Texture41_g61277 );
				float4 Multi28_g61277 = temp_output_15_0_g61277;
				float4 Sub28_g61277 = Albedo_Texture41_g61277;
				float4 RGBA28_g61277 = float4( 0,0,0,0 );
				effectsControl_float( Layer28_g61277 , Base28_g61277 , Add28_g61277 , Multi28_g61277 , Sub28_g61277 , RGBA28_g61277 );
				float3 WorldPosition288_g61291 = PositionWS;
				...
				half2 LightmapUV1_g61288 = (input.ase_texcoord4.zw*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				...
				float3 Color = ( ( ( ( saturate( ( temp_cast_0 - ( _ShadowLum * ( temp_cast_1 - ( temp_output_23_0_g61293 == (float)0 ? tex2DNode33_g61293 : lerpResult9_g61293 ) ) ) ) ) * float4( Light_Color25_g61286 , 0.0 ) * RGBA33_g61277 ) + ( ( pow( saturate( dotResult1_g61285 ) , max( _Shininess, 0.001 ) ) * _Specular * float4( Light_Color25_g61286 , 0.0 ) ) * _SpecularIntensity ) ) + ( RGBA28_g61277 * float4( ( Additional_Lights268 * Ambient_Blend_Factor48 ) , 0.0 ) ) ) * _HDR ).xyz;
				float Alpha = ( Sgurface248 == (float)0 ? (float)1 : saturate( ( _Opaque * ( Layer289 == (float)3 ? ( tex2DNode10_g61277.a * tex2DNode10.w ) : tex2DNode10.w ) ) ) );
				#if defined( _ALPHATEST_ON )
					float AlphaClipThreshold = Alpha_Clip_Threshold323;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				surfaceDescription.Alpha = ( Sgurface248 == (float)0 ? (float)1 : saturate( ( _Opaque * ( Layer289 == (float)3 ? ( tex2DNode10_g61277.a * tex2DNode10.w ) : tex2DNode10.w ) ) ) );
				#if defined( _ALPHATEST_ON )
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;252;-7680,-6528;Inherit;False;1024.206;1407.06;Surface Options;15;323;574;227;510;224;225;232;226;231;230;229;221;248;223;616;ERROR;1,0,0,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;227;-7648,-5376;Float;True;Property;_Cutoff;Alpha Cutoff;30;1;[HideInInspector];Fetch;False;0;0;0;True;0;False;0.5;0.669;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;616;-7552,-5664;Inherit;True;Property;_AlphaClip1;Alpha Clip;32;0;Fetch;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;574;-7328,-5664;Inherit;True;Alpha Clip Threshold (Amplify Shader Editor);-1;;61279;171eab994f1a2214cbab7964a5267fe1;0;2;7;FLOAT;0;False;6;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;533;-5472,-3680;Inherit;True;N dot L (Amplify Shader Editor);-1;;61280;96e0e28ec623e134ba66ab21882969ae;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;542;-4736,-4288;Inherit;True;Toon Shadow Mask (Amplify Shader Editor);-1;;61281;d4c61b1560e7f524485e042d9cbfa12f;0;1;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;556;-4736,-3904;Inherit;True;Baked LightMap Contribution (Amplify Shader Editor);-1;;61282;b0308fde66b3df54883fd907b3a91063;0;1;12;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;611;-6048,-5632;Inherit;True;Outline Control (Amplify Shader Editor);-1;;61294;9b89aaf063c597e47936ca5e506b1b8f;0;4;28;FLOAT;0;False;32;FLOAT;0;False;25;COLOR;0,0,0,1;False;24;FLOAT;0;False;3;FLOAT3;29;FLOAT;0;FLOAT3;30
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;221;-7424,-5952;Inherit;True;Property;_CastShadows;Cast Shadows;31;1;[HideInInspector];Create;False;0;0;0;True;0;False;1;1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=D9CD9D04926273DBD1553F0C0640C8902DE8E518