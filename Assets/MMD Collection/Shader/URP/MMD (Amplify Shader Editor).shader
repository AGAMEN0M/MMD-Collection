	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 lightmapUV444 = (IN.ase_texcoord6.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				...
				float3 Color = ( saturate( ( FinalColor336 * float4( Output444 , 0.0 ) ) ) * _HDR ).rgb;
...
Node;AmplifyShaderEditor.CommentaryNode;446;-736,-1536;Inherit;False;514.4;192.7999;Baked Lightmaps;2;447;444;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;442;-3904,-2560;Inherit;False;SRP Additional Light;-1;;94;6c86746ad131a0a408ca599df5f40861;8,212,1,6,1,9,1,23,0,142,1,168,1,154,1,24,1;6;2;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;15;FLOAT3;0,0,0;False;14;FLOAT3;0,0,0;False;18;FLOAT;0.5;False;32;FLOAT4;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;440;-4480,-2304;Inherit;False;Lightmap UV;-1;;95;1940f027d0458684eb0ad486f669d7d5;1,1,1;0;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;443;-128,-1920;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CustomExpressionNode;444;-480,-1472;Float;False;#pragma multi_compile _ _ADDITIONAL_LIGHTS_VERTEX _ADDITIONAL_LIGHTS$#pragma multi_compile_fragment _ _ADDITIONAL_LIGHT_SHADOWS$#pragma multi_compile_fragment _ _SHADOWS_SOFT$#pragma multi_compile _ SHADOWS_SHADOWMASK$$$#pragma multi_compile _ LIGHTMAP_SHADOW_MIXING$$float3 diffuseColor = 0@$WorldNormal = normalize( WorldNormal)@$$int pixelLightCount = GetAdditionalLightsCount()@$for(int i = 0@  i < pixelLightCount@ i++)${$	Light light = GetAdditionalLight(i, WorldPosition)@$        	half3 attenuatedLightColor = light.color * (light.distanceAttenuation * light.shadowAttenuation)@$        	diffuseColor += LightingLambert(attenuatedLightColor, light.direction, WorldNormal)@$}$$return diffuseColor@$;7;File;2;True;lightmapUV;FLOAT2;0,0;In;;Inherit;False;True;Output;FLOAT3;0,0,0;Out;;Inherit;False;lightmapCol;False;False;0;eaabac11517cd514998e1309a04e4362;True;3;0;FLOAT;0;False;1;FLOAT2;0,0;False;2;FLOAT3;0,0,0;False;2;FLOAT;0;FLOAT3;3
...
Node;AmplifyShaderEditor.SaturateNode;452;96,-1920;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;371;320,-1920;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;370;0,-1536;Inherit;True;Property;_HDR;HDR;18;0;Create;True;0;0;0;False;0;False;1;1;1;1000;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;447;-704,-1472;Inherit;False;Lightmap UV;-1;;96;1940f027d0458684eb0ad486f669d7d5;1,1,0;0;1;FLOAT2;0
...
ASEEND*/
//CHKSM=238F99ABBE99B55B489469B66D1D101F84832E4D