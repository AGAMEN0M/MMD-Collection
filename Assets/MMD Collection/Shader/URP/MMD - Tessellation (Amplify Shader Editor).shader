	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float temp_output_9_0_g61340 = _ExtrusionAmount;
				...
				float3 vertexValue = ( Status23_g61355 == (float)0 ? temp_cast_1 : ( ( _EdgeSize + temp_output_9_0_g61340 ) * input.normalOS ) );
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float temp_output_9_0_g61340 = _ExtrusionAmount;
				float3 Extrusion_Vertex_Offset625 = ( temp_output_9_0_g61340 * input.normalOS );
						 ...
						 ) : SV_Target
			{
				...
				float3 temp_output_12_0_g61346 = OutputColor15_g61343;
				float3 temp_cast_5 = 0;
				float locallightmapCol11_g61346 = ( 0.0 );
				float2 lightmapUV11_g61346 = (input.ase_texcoord4.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float3 Output11_g61346 = float3( 0,0,0 );
				lightmapCol_float( lightmapUV11_g61346 , Output11_g61346 );
				#ifdef LIGHTMAP_ON
				float3 staticSwitch8_g61346 = ( ( temp_output_12_0_g61346 == temp_cast_5 ? ( Output11_g61346 * 2.0 ) : temp_output_12_0_g61346 ) + Output11_g61346 );
				#else
				float3 staticSwitch8_g61346 = temp_output_12_0_g61346;
				#endif
				half3 Global_Light_Scale139 = half3( 0.6, 0.6, 0.6 );
				float3 Light_Color25_g61348 = ( staticSwitch8_g61346 * Global_Light_Scale139 );
				float localvLight3_g61329 = ( 0.0 );
				float3 objToWorldDir2_g61329 = mul( GetObjectToWorldMatrix(), float4( input.ase_normal, 0.0 ) ).xyz;
				float3 normal3_g61329 = objToWorldDir2_g61329;
				float3 Output3_g61329 = float3( 0,0,0 );
				vLight_float( normal3_g61329 , Output3_g61329 );
				float3 temp_output_630_0 = Output3_g61329;
				float3 Ambient_Blend_Factor48 = ( float3( 1, 1, 1 ) - ( max( ( half3( 0.5, 0.5, 0.5 ) - (_Ambient).rgb ), float3( 0, 0, 0 ) ) * ( half3( 1, 1, 1 ) / 0.5 ) ) );
				float3 Weighted_Ambient144 = ( temp_output_630_0 * Ambient_Blend_Factor48 );
				float3 Temp_Diffuse46_g61334 = max( ( min( ( (_Ambient).rgb + ( (_Color).rgb * Global_Light_Scale139 ) ), float3( 1, 1, 1 ) ) - Weighted_Ambient144 ), float3( 0, 0, 0 ) );
				float2 uv_MainTex = input.ase_texcoord5.xyz.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode10 = tex2D( _MainTex, uv_MainTex );
				float4 Albedo_Texture41_g61334 = tex2DNode10;
				float4 temp_output_18_0_g61334 = ( float4( Temp_Diffuse46_g61334 , 0.0 ) * Albedo_Texture41_g61334 );
				float3 objToView2_g61333 = TransformWorldToView( TransformObjectToWorld(input.ase_texcoord3.xyz) );
				float3 normalizeResult4_g61333 = normalize( objToView2_g61333 );
				float3 objToViewDir3_g61333 = normalize( mul( UNITY_MATRIX_IT_MV, float4( input.ase_normal, 0.0 ) ).xyz );
				float3 normalizeResult5_g61333 = normalize( objToViewDir3_g61333 );
				float4 temp_output_27_0_g61334 = ( texCUBE( _SphereCube, reflect( normalizeResult4_g61333 , normalizeResult5_g61333 ) ) * _SPHOpacity );
				float Layer289 = _EFFECTS;
				float Effect_Layer13_g61334 = Layer289;
				float Layer_Value17_g61335 = Effect_Layer13_g61334;
				float4 lerpResult6_g61335 = lerp( temp_output_18_0_g61334 , ( temp_output_18_0_g61334 + temp_output_27_0_g61334 ) , step( 0.5 , Layer_Value17_g61335 ));
				float4 temp_output_15_0_g61334 = ( temp_output_27_0_g61334 * Albedo_Texture41_g61334 );
				float4 lerpResult14_g61335 = lerp( lerpResult6_g61335 , ( temp_output_15_0_g61334 * float4( Temp_Diffuse46_g61334 , 0.0 ) ) , step( 1.5 , Layer_Value17_g61335 ));
				...
				float Layer_Value17_g61337 = (float)_UVLayer;
				float2 lerpResult6_g61337 = lerp( uv_SubTex , uv2_SubTex , step( 0.5 , Layer_Value17_g61337 ));
				float2 uv3_SubTex = input.ase_texcoord4.zw * _SubTex_ST.xy + _SubTex_ST.zw;
				float2 lerpResult14_g61337 = lerp( lerpResult6_g61337 , uv3_SubTex , step( 1.5 , Layer_Value17_g61337 ));
				float2 uv4_SubTex = input.ase_texcoord6.xy * _SubTex_ST.xy + _SubTex_ST.zw;
				float2 lerpResult16_g61337 = lerp( lerpResult14_g61337 , uv4_SubTex , step( 2.5 , Layer_Value17_g61337 ));
				float4 tex2DNode10_g61334 = tex2D( _SubTex, lerpResult16_g61337 );
				float4 lerpResult16_g61335 = lerp( lerpResult14_g61335 , ( float4( Temp_Diffuse46_g61334 , 0.0 ) * Albedo_Texture41_g61334 * tex2DNode10_g61334 ) , step( 2.5 , Layer_Value17_g61335 ));
				...
				float Layer_Value17_g61336 = Effect_Layer13_g61334;
				float4 lerpResult6_g61336 = lerp( Albedo_Texture41_g61334 , ( temp_output_27_0_g61334 + Albedo_Texture41_g61334 ) , step( 0.5 , Layer_Value17_g61336 ));
				float4 lerpResult14_g61336 = lerp( lerpResult6_g61336 , temp_output_15_0_g61334 , step( 1.5 , Layer_Value17_g61336 ));
				float4 lerpResult16_g61336 = lerp( lerpResult14_g61336 , Albedo_Texture41_g61334 , step( 2.5 , Layer_Value17_g61336 ));
				float3 WorldPosition288_g61350 = PositionWS;
				float3 WorldPosition337_g61350 = WorldPosition288_g61350;
				float2 ScreenUV286_g61350 = (ScreenPosNorm).xy;
				float2 ScreenUV337_g61350 = ScreenUV286_g61350;
				...
				float3 Additional_Lights268 = ( _MultipleLights == (float)1 ? ( localAdditionalLightsLambertMask171x337_g61350 + temp_output_13_0_g61349 ) : temp_output_13_0_g61349 );
				...
				float3 Color = ( ( ( ( saturate( ( temp_cast_0 - ( _ShadowLum * ( temp_cast_1 - ( temp_output_23_0_g61345 == (float)0 ? tex2DNode33_g61345 : lerpResult9_g61345 ) ) ) ) ) * float4( Light_Color25_g61348 , 0.0 ) * lerpResult16_g61335 ) + ( ( pow( saturate( dotResult1_g61344 ) , max( _Shininess, 0.001 ) ) * _Specular * float4( Light_Color25_g61348 , 0.0 ) ) * _SpecularIntensity ) ) + ( lerpResult16_g61336 * float4( ( Additional_Lights268 * Ambient_Blend_Factor48 ) , 0.0 ) ) ) * _HDR ).rgb;
				float Alpha = ( Sgurface248 == (float)0 ? (float)1 : saturate( ( _Opaque * ( Layer289 == (float)3 ? ( tex2DNode10_g61334.a * tex2DNode10.a ) : tex2DNode10.a ) ) ) );
				#if defined( _ALPHATEST_ON )
					float AlphaClipThreshold = Alpha_Clip_Threshold323;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				surfaceDescription.Alpha = ( Sgurface248 == (float)0 ? (float)1 : saturate( ( _Opaque * ( Layer289 == (float)3 ? ( tex2DNode10_g61334.a * tex2DNode10.a ) : tex2DNode10.a ) ) ) );
				#if defined( _ALPHATEST_ON )
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;629;-6272,-2912;Inherit;True;Ambient Blend Factor (Amplify Shader Editor);-1;;61328;c421f4bc8a9adda44bd4cd4e12093875;0;1;7;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;630;-5920,-3136;Inherit;True;Global Ambient (Amplify Shader Editor);-1;;61329;2ba15a2d50724194cb38a2ebb214fec5;0;0;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;631;-5472,-3136;Inherit;True;Weighted Ambient (Amplify Shader Editor);-1;;61330;c74b4378eb191434689832628f4ac715;0;2;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;632;-7648,-2912;Inherit;True;MMD Constants (Amplify Shader Editor);-1;;61331;418dddb8757e55344877d4066e563a11;0;0;3;FLOAT3;1;FLOAT3;2;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;633;-6720,-2592;Inherit;True;Balanced Diffuse (Amplify Shader Editor);-1;;61332;b9d74c6ebcf90ea4dba95e1f0d9a6f0b;0;4;22;FLOAT3;0.6,0.6,0.6;False;23;FLOAT3;0,0,0;False;20;COLOR;1,1,1,0;False;21;COLOR;0.8,0.8,0.8,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;223;-7648,-6464;Inherit;True;Property;_Surface;Surface Type;25;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;634;-6496,-2080;Inherit;True;Sphere Map UV (Amplify Shader Editor);-1;;61333;5f56ef3cc5ba0704c81e1b4a6eaa4beb;0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;227;-7648,-5376;Float;True;Property;_Cutoff;Alpha Cutoff;34;1;[HideInInspector];Fetch;False;0;0;0;True;0;False;0.5;0.669;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;228;-7552,-5664;Inherit;True;Property;_AlphaClip;Alpha Clip;33;1;[HideInInspector];Fetch;False;0;0;0;True;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;635;-5568,-2080;Inherit;True;Sphere Map Blend (Amplify Shader Editor);-1;;61334;40c32954e5f9d9046ae98d6e4ad2a766;0;7;38;FLOAT;0;False;40;FLOAT;0;False;45;FLOAT3;1,1,1;False;43;COLOR;1,1,1,1;False;44;FLOAT;1;False;47;SAMPLER2D;1,1,1,1;False;42;COLOR;1,1,1,1;False;3;COLOR;0;COLOR;1;FLOAT;37
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;636;-5056,-1440;Inherit;True;Transparency Control (Amplify Shader Editor);-1;;61338;6d43ae7b10f2e8e4ca2eeb598d02c48d;0;5;16;FLOAT;1;False;15;COLOR;1,1,1,1;False;17;FLOAT;0;False;18;FLOAT;1;False;19;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;638;-6304,-5632;Inherit;True;Extrusion Amount Calculation (Amplify Shader Editor);-1;;61340;e5ebc5dc6bc5c3d41b2c1a8fb58a735f;0;2;8;FLOAT;0;False;9;FLOAT;0;False;2;FLOAT;0;FLOAT3;7
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;232;-7648,-6208;Inherit;True;Property;_SrcBlend;Src Blend (Auto);28;1;[HideInInspector];Create;False;0;0;0;True;0;False;1;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;226;-7424,-6208;Inherit;True;Property;_DstBlend;Dst Blend (Auto);29;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;644;-4736,-3904;Inherit;True;Baked LightMap Contribution (Amplify Shader Editor);-1;;61346;b0308fde66b3df54883fd907b3a91063;0;1;12;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;645;-2592,-2816;Inherit;True;Final Lighting Composition (Amplify Shader Editor);-1;;61348;cc1fc2fda045d8b4aa23e1107f6b1fd6;0;11;29;FLOAT3;0.6,0.6,0.6;False;31;COLOR;0,0,0,0;False;28;FLOAT3;0,0,0;False;37;COLOR;0,0,0,0;False;32;COLOR;0,0,0,0;False;33;FLOAT;0;False;34;COLOR;0,0,0,0;False;35;FLOAT;1;False;38;FLOAT3;0,0,0;False;39;FLOAT3;0,0,0;False;41;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;646;-5472,-3424;Inherit;True;Additional Lights (Amplify Shader Editor);-1;;61349;0903e89e038650f4c8f73f079567a741;0;2;15;FLOAT;1;False;13;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;647;-5824,-5984;Inherit;True;Outline Control (Amplify Shader Editor);-1;;61355;9b89aaf063c597e47936ca5e506b1b8f;0;4;28;FLOAT;0;False;32;FLOAT;0;False;25;COLOR;0,0,0,1;False;24;FLOAT;0;False;3;FLOAT3;29;FLOAT;0;FLOAT3;30
...
WireConnection;628;11;632;2
WireConnection;628;13;28;0
WireConnection;629;7;628;0
WireConnection;48;0;629;0
WireConnection;631;2;630;0
WireConnection;631;3;48;0
WireConnection;144;0;631;0
WireConnection;139;0;632;0
WireConnection;633;22;139;0
WireConnection;633;23;145;0
WireConnection;633;20;28;0
WireConnection;633;21;11;0
WireConnection;601;0;633;0
WireConnection;40;1;634;0
WireConnection;602;0;601;0
WireConnection;289;0;207;0
WireConnection;248;0;223;0
WireConnection;635;38;289;0
WireConnection;635;40;384;0
WireConnection;635;45;602;0
WireConnection;635;43;40;0
WireConnection;635;44;56;0
WireConnection;635;47;478;0
WireConnection;635;42;10;0
WireConnection;636;16;635;37
WireConnection;636;15;10;0
WireConnection;636;17;410;0
WireConnection;636;18;16;0
WireConnection;636;19;249;0
WireConnection;637;7;228;0
WireConnection;637;6;227;0
WireConnection;638;8;201;0
WireConnection;638;9;622;0
WireConnection;606;0;636;0
WireConnection;323;0;637;0
WireConnection;625;0;638;7
WireConnection;604;0;635;0
WireConnection;605;0;635;1
WireConnection;603;0;643;0
WireConnection;607;0;606;0
WireConnection;609;0;644;0
WireConnection;268;0;646;0
...
WireConnection;644;12;641;18
WireConnection;645;29;176;0
WireConnection;645;31;603;0
WireConnection;645;28;609;0
WireConnection;645;37;604;0
WireConnection;645;32;605;0
WireConnection;645;33;642;0
WireConnection;645;34;82;0
WireConnection;645;35;88;0
WireConnection;645;38;196;0
WireConnection;645;39;197;0
WireConnection;645;41;370;0
WireConnection;646;15;307;0
WireConnection;646;13;630;0
WireConnection;647;28;612;0
WireConnection;647;32;438;0
WireConnection;647;25;208;0
WireConnection;647;24;638;0
WireConnection;499;2;645;0
WireConnection;499;3;607;0
WireConnection;499;4;325;0
WireConnection;499;5;626;0
WireConnection;498;0;647;29
