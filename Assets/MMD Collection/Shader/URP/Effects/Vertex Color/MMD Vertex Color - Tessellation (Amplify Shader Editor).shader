...
Shader "MMD Collection/URP/Effects/MMD Vertex Color - Tessellation (Amplify Shader Editor)"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float temp_output_9_0_g61348 = _ExtrusionAmount;
				float3 Extrusion_Vertex_Offset642 = ( temp_output_9_0_g61348 * input.normalOS );
						 ...
						 ) : SV_Target
			{
				...
				float4 break5_g61312 = pow( saturate( ( 1.0 - input.ase_color ) ) , temp_cast_8 );
				float4 lerpResult1_g61312 = lerp( tex2D( _MainTex, uv_MainTex ) , tex2D( _MainTexR, uv_MainTexR ) , break5_g61312.r);
				float2 uv_MainTexG = input.ase_texcoord5.xyz.xy * _MainTexG_ST.xy + _MainTexG_ST.zw;
				float4 lerpResult2_g61312 = lerp( lerpResult1_g61312 , tex2D( _MainTexG, uv_MainTexG ) , break5_g61312.g);
				float2 uv_MainTexB = input.ase_texcoord5.xyz.xy * _MainTexB_ST.xy + _MainTexB_ST.zw;
				float4 lerpResult3_g61312 = lerp( lerpResult2_g61312 , tex2D( _MainTexB, uv_MainTexB ) , break5_g61312.b);
				float2 uv_MainTexA = input.ase_texcoord5.xyz.xy * _MainTexA_ST.xy + _MainTexA_ST.zw;
				float4 lerpResult4_g61312 = lerp( lerpResult3_g61312 , tex2D( _MainTexA, uv_MainTexA ) , break5_g61312.a);
				float4 temp_output_640_0 = lerpResult4_g61312;
				float4 Albedo_Texture41_g61313 = temp_output_640_0;
				...
				float3 Color = ( ( ( ( saturate( ( temp_cast_0 - ( _ShadowLum * ( temp_cast_1 - ( temp_output_23_0_g61353 == (float)0 ? tex2DNode33_g61353 : lerpResult9_g61353 ) ) ) ) ) * float4( Light_Color25_g61356 , 0.0 ) * lerpResult16_g61314 ) + ( ( pow( saturate( dotResult1_g61352 ) , max( _Shininess, 0.001 ) ) * _Specular * float4( Light_Color25_g61356 , 0.0 ) ) * _SpecularIntensity ) ) + ( lerpResult16_g61315 * float4( ( Additional_Lights268 * Ambient_Blend_Factor48 ) , 0.0 ) ) ) * _HDR ).rgb;
				float Alpha = ( Sgurface248 == (float)0 ? (float)1 : saturate( ( _Opaque * ( Layer289 == (float)3 ? ( tex2DNode10_g61313.a * temp_output_640_0.a ) : temp_output_640_0.a ) ) ) );
				#if defined( _ALPHATEST_ON )
					float AlphaClipThreshold = Alpha_Clip_Threshold323;
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 break5_g61312 = pow( saturate( ( 1.0 - input.ase_color ) ) , temp_cast_4 );
				float4 lerpResult1_g61312 = lerp( tex2D( _MainTex, uv_MainTex ) , tex2D( _MainTexR, uv_MainTexR ) , break5_g61312.r);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				surfaceDescription.Alpha = ( Sgurface248 == (float)0 ? (float)1 : saturate( ( _Opaque * ( Layer289 == (float)3 ? ( tex2DNode10_g61313.a * temp_output_640_0.a ) : temp_output_640_0.a ) ) ) );
				#if defined( _ALPHATEST_ON )
	...
	CustomEditor "MMDVertexColorTessellationCustomInspector_AmplifyShaderEditor"
...
/*ASEBEGIN
Version=19907
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;610;-7680,-5056;Inherit;False;6561.605;4258.632;MMD Material Calculation;55;499;292;591;558;429;325;370;196;268;197;176;609;607;553;122;603;605;88;82;604;555;589;47;542;533;307;606;592;249;410;16;594;289;384;602;478;56;40;207;601;547;598;145;139;11;144;578;48;549;577;599;600;28;639;643;;0,1,0,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;640;-6848,-672;Inherit;True;Vertex Color Mask (Amplify Shader Editor);1;;61312;99eaca6ba1e21f648b61b12d61cf9c82;0;6;21;FLOAT;0;False;22;COLOR;0,0,0,1;False;23;COLOR;1,0,0,1;False;24;COLOR;0,1,0,1;False;25;COLOR;0,0,1,1;False;26;COLOR;1,1,1,1;False;5;COLOR;0;FLOAT;16;FLOAT;17;FLOAT;18;FLOAT;19
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;275;-6592,-6176;Inherit;False;1406.115;1055.416;Outline;9;498;611;644;642;622;201;208;438;612;;0,1,0,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;644;-6304,-5632;Inherit;True;Extrusion Amount Calculation (Amplify Shader Editor);-1;;61348;e5ebc5dc6bc5c3d41b2c1a8fb58a735f;0;2;8;FLOAT;0;False;9;FLOAT;0;False;2;FLOAT;0;FLOAT3;7
...
WireConnection;640;21;632;0
WireConnection;640;22;10;0
WireConnection;640;23;633;0
WireConnection;640;24;634;0
WireConnection;640;25;635;0
WireConnection;640;26;637;0
...
WireConnection;594;42;638;0
WireConnection;639;0;640;0
WireConnection;592;16;594;37
WireConnection;592;15;639;0
...
WireConnection;644;8;201;0
WireConnection;644;9;622;0
WireConnection;606;0;592;0
WireConnection;323;0;574;0
WireConnection;642;0;644;7
...
ASEEND*/
//CHKSM=A5549AFC435A76361933E906F594BFA425B4BFFD