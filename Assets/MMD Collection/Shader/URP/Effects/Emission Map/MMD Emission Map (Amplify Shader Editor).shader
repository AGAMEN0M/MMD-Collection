	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 Base_Color627 = ( ( ( ( saturate( ( temp_cast_0 - ( _ShadowLum * ( temp_cast_1 - ( temp_output_23_0_g61315 == (float)0 ? tex2DNode33_g61315 : lerpResult9_g61315 ) ) ) ) ) * float4( Light_Color25_g61319 , 0.0 ) * lerpResult16_g61278 ) + ( ( pow( saturate( dotResult1_g61314 ) , max( _Shininess, 0.001 ) ) * _Specular * float4( Light_Color25_g61319 , 0.0 ) ) * _SpecularIntensity ) ) + ( lerpResult16_g61279 * float4( ( Additional_Lights268 * Ambient_Blend_Factor48 ) , 0.0 ) ) ) * _HDR );
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;621;-1056,-2816;Inherit;False;1024.799;671.9922;Emission Map;5;626;625;624;623;622;;0,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;622;-640,-2624;Inherit;True;Emission Map (Amplify Shader Editor);-1;;61327;7335655d9ede5bf4599b2a5c3dc270b7;0;3;1;COLOR;0,0,0,0;False;2;SAMPLER2D;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;622;1;626;0
WireConnection;622;2;624;0
WireConnection;622;3;623;0
...
ASEEND*/
//CHKSM=A18294FEEEC3202034CF24BB7175A3185EAA67F8