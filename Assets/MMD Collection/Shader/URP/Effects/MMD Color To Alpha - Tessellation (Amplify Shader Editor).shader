...
Shader "MMD Collection/URP/Effects/MMD Color To Alpha - Tessellation (Amplify Shader Editor)"
{
	...
	SubShader
	{
		...
		Tags { "RenderPipeline"="UniversalPipeline" "RenderType"="_Surface" "Queue"="Overlay-1000" "UniversalMaterialType"="Unlit" }
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 objToWorld114 = mul( GetObjectToWorldMatrix(), float4( input.ase_texcoord6.xyz, 1 ) ).xyz;
				...
				float2 lightmapUV454 = (input.ase_texcoord7.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				...
				float3 objToView109 = mul( UNITY_MATRIX_MV, float4( input.ase_texcoord6.xyz, 1 ) ).xyz;
				...
				float2 uv0391 = input.ase_texcoord8.xyz.xy;
				float2 uv1391 = input.ase_texcoord8.xyz.xy;
				float2 uv2391 = input.ase_texcoord8.xyz.xy;
				float2 uv3391 = input.ase_texcoord8.xyz.xy;
				...
				float3 worldPosValue184_g103 = WorldPosition;
				float3 WorldPosition173_g103 = worldPosValue184_g103;
				float4 ase_positionSSNorm = ScreenPos / ScreenPos.w;
				ase_positionSSNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_positionSSNorm.z : ase_positionSSNorm.z * 0.5 + 0.5;
				float2 ScreenUV183_g103 = (ase_positionSSNorm).xy;
				float2 ScreenUV173_g103 = ScreenUV183_g103;
				float3 objToWorldDir261 = mul( GetObjectToWorldMatrix(), float4( input.ase_normal, 0.0 ) ).xyz;
				float3 worldNormalValue185_g103 = objToWorldDir261;
				float3 WorldNormal173_g103 = worldNormalValue185_g103;
				half2 LightmapUV1_g101 = (input.ase_texcoord7.zw*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				half4 localCalculateShadowMask1_g101 = CalculateShadowMask1_g101( LightmapUV1_g101 );
				float4 shadowMaskValue182_g103 = localCalculateShadowMask1_g101;
				float4 ShadowMask173_g103 = shadowMaskValue182_g103;
				float3 localAdditionalLightsLambertMask17x173_g103 = AdditionalLightsLambertMask17x( WorldPosition173_g103 , ScreenUV173_g103 , WorldNormal173_g103 , ShadowMask173_g103 );
				float3 mmdAdditionalLights268 = ( _MultipleLights == (float)1 ? ( localAdditionalLightsLambertMask17x173_g103 + globalAmbient143 ) : globalAmbient143 );
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				int localuvLayer391 = ( 0 );
				float Layer391 = (float)_UVLayer;
				float2 uv0391 = input.ase_texcoord3.xy;
				float2 uv1391 = input.ase_texcoord3.xy;
				float2 uv2391 = input.ase_texcoord3.xy;
				float2 uv3391 = input.ase_texcoord3.xy;
				float2 UV391 = float2( 0,0 );
				uvLayer_float( Layer391 , uv0391 , uv1391 , uv2391 , uv3391 , UV391 );
				float4 tex2DNode379 = tex2D( _SubTex, UV391 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				int localuvLayer391 = ( 0 );
				float Layer391 = (float)_UVLayer;
				float2 uv0391 = input.ase_texcoord.xy;
				float2 uv1391 = input.ase_texcoord.xy;
				float2 uv2391 = input.ase_texcoord.xy;
				float2 uv3391 = input.ase_texcoord.xy;
				float2 UV391 = float2( 0,0 );
				uvLayer_float( Layer391 , uv0391 , uv1391 , uv2391 , uv3391 , UV391 );
				float4 tex2DNode379 = tex2D( _SubTex, UV391 );
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.CommentaryNode;282;-2656,-4160;Inherit;False;2145.128;2174.384;Sphere Map Composition - Option to Add, Multiply, Sub Tex, Turn off the effect;37;401;399;408;284;400;379;57;63;56;289;207;407;406;405;283;377;378;380;80;75;78;79;77;73;39;71;477;478;384;484;391;485;486;487;488;527;531;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;478;-2560,-2816;Inherit;True;Property;_SubTex;SPH SubTex;18;0;Create;False;0;0;0;False;0;False;None;a4bd0e91e1c27e244a687b69ae743b93;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.IntNode;384;-2080,-2624;Inherit;False;Property;_UVLayer;UV Layer;17;1;[Enum];Create;True;0;4;Layer 1;0;Layer 2;1;Layer 3;2;Layer 4;3;0;False;0;False;0;1;False;0;1;INT;0
Node;AmplifyShaderEditor.TexCoordVertexDataNode;531;-2464,-2368;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;276;-1408,-1408;Inherit;False;1792.641;864.4399;Color Transparency;15;246;205;249;247;250;27;412;16;414;411;410;413;17;14;415;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;207;-1600,-4064;Inherit;True;Property;_EFFECTS;Effects;13;2;[Header];[Enum];Create;False;1;Texture (Memo);4;Disabled;0;Add Sphere;1;Multi Sphere;2;Sub Tex;3;0;False;0;False;0;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;477;-1168,-2192;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;14;-1344,-800;Inherit;False;12;Albedo;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;17;-1152,-800;Inherit;True;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.WireNode;415;-1040,-1104;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;535;-1152,-480;Inherit;False;770.4;478.95;Color To Alpha;4;538;537;536;539;;0.06514812,1,0,1;0;0
...
Node;AmplifyShaderEditor.IntNode;413;-864,-1168;Inherit;False;Constant;_Int0;Int 0;32;0;Create;True;0;0;0;False;0;False;3;0;False;0;1;INT;0
Node;AmplifyShaderEditor.GetLocalVarNode;410;-928,-1264;Inherit;False;289;tSphereMapBlend;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;411;-912,-1024;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;414;-688,-816;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;536;-992,-416;Inherit;False;12;Albedo;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;538;-1120,-320;Inherit;False;Property;_ColortoAlpha;Color to Alpha;29;0;Create;True;1;Add Effects;0;0;False;0;False;1,1,1,1;1,1,1,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;539;-1088,-96;Inherit;False;Property;_ColorTolerance;Color Tolerance;30;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Compare;412;-576,-1056;Inherit;True;0;4;0;FLOAT;0;False;1;INT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;227;-2272,-6528;Inherit;True;Property;_Cutoff;Alpha Cutoff;40;1;[HideInInspector];Create;False;0;0;0;True;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;228;-2112,-6816;Inherit;True;Property;_AlphaClip;Alpha Clip;39;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-608,-1344;Inherit;True;Property;_Opaque;Opaque;7;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;512;-1920,-6272;Inherit;False;Property;_ExtrusionAmount;Extrusion Amount;28;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;537;-768,-416;Inherit;False;Color To Alpha (Amplify Shader Editor);1;;100;c56b444fd5d5e994bb6ccc7147b8541a;0;3;9;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;223;-2336,-7584;Inherit;True;Property;_Surface;Surface Type;31;1;[HideInInspector];Create;False;0;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;-288,-1056;Inherit;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;278;-1344,-7584;Inherit;False;1246.42;666.926;Color and Transparency Line;12;317;318;316;315;313;209;216;293;214;251;208;509;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;335;96,-1984;Inherit;False;223.0586;286.2802;Fog;2;519;373;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.IntNode;250;-64,-1152;Inherit;False;Constant;_Int5;Int 0;10;0;Create;True;0;0;0;False;0;False;1;0;False;0;1;INT;0
Node;AmplifyShaderEditor.IntNode;247;-64,-1248;Inherit;False;Constant;_Int4;Int 0;10;0;Create;True;0;0;0;False;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.GetLocalVarNode;249;-128,-1344;Inherit;False;248;tSgurfaceType;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Compare;246;128,-1248;Inherit;True;0;4;0;FLOAT;0;False;1;INT;0;False;2;INT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;221;-2112,-7072;Inherit;True;Property;_CastShadows;Cast Shadows;41;1;[HideInInspector];Create;False;0;0;0;True;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;229;-2336,-7072;Inherit;True;Property;_ZTest;_ZTest;38;1;[HideInInspector];Create;False;0;0;0;True;0;False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;230;-1664,-7328;Inherit;True;Property;_ZWriteControl;_ZWriteControl;37;1;[HideInInspector];Create;False;0;0;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;231;-1888,-7328;Inherit;True;Property;_ZWrite;__zw;36;1;[HideInInspector];Create;False;0;0;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;226;-2112,-7328;Inherit;True;Property;_DstBlend;__dst;35;1;[HideInInspector];Create;False;0;0;0;True;0;False;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;232;-2336,-7328;Inherit;True;Property;_SrcBlend;__src;34;1;[HideInInspector];Create;False;0;0;0;True;0;False;5;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;225;-1664,-7584;Inherit;True;Property;_Cull;Render Face;33;1;[HideInInspector];Create;False;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;224;-1888,-7584;Inherit;True;Property;_Blend;Blending Mode;32;1;[HideInInspector];Create;False;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;292;-2848,-7584;Inherit;True;Property;_ToonTone;Toon Tone;23;0;Create;False;0;0;0;False;0;False;1,0.5,0.5;1,0.5,0.5;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;47;192,-4928;Inherit;True;Property;_ShadowLum;Shadow Luminescence;21;0;Create;False;0;0;0;False;0;False;1.5;1.5;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;56;-2624,-3488;Inherit;True;Property;_SPHOpacity;SPH Opacity;20;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;88;-128,-2784;Inherit;True;Property;_SpecularIntensity;Specular Intensity;19;1;[Header];Create;True;1;Custom Effects Settings;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;208;-1312,-7424;Inherit;False;Property;_OutlineColor;Color;11;0;Create;False;0;0;0;False;0;False;0,0,0,1;0,0,0,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;122;-3648,-2592;Inherit;True;Property;_Shininess;Reflection;8;0;Create;False;0;0;0;False;0;False;50;50;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;28;-2880,-6816;Inherit;False;Property;_Ambient;Ambient;6;0;Create;True;1;;0;0;False;0;False;1,1,1,0;0,1,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;82;-416,-2944;Inherit;False;Property;_Specular;Specular;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.6,0.1999999,0.6,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;92;-672,-4768;Inherit;True;Property;_ToonTex;Toon;15;1;[NoScaleOffset];Create;False;0;0;0;False;0;False;-1;None;f35b8759e2061eb469494abb58b512c1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;429;-1152,-4992;Inherit;True;Property;_SShad;S-Shad;9;2;[Header];[ToggleUI];Create;True;1;Rendering;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;307;-3488,-1984;Inherit;True;Property;_MultipleLights;Multiple Lights;24;1;[ToggleUI];Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;441;-4224,-1472;Inherit;False;Shadow Mask;-1;;101;b50f5becdd6b8504a861ba5b9b861159;0;1;3;FLOAT2;0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;442;-3904,-1728;Inherit;False;SRP Additional Light;-1;;103;6c86746ad131a0a408ca599df5f40861;3,6,1,9,1,23,0;6;2;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;15;FLOAT3;0,0,0;False;14;FLOAT3;0,0,0;False;18;FLOAT;0.5;False;32;FLOAT4;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;440;-4480,-1472;Inherit;False;Lightmap UV;-1;;105;1940f027d0458684eb0ad486f669d7d5;1,1,1;0;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;455;-4832,-3648;Inherit;False;Lightmap UV;-1;;106;1940f027d0458684eb0ad486f669d7d5;1,1,0;0;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;510;-1888,-7072;Inherit;False;Property;_EdgeLength;Edge Length;26;0;Create;True;0;0;0;True;0;False;5;5;2;50;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;511;-1888,-6976;Inherit;False;Property;_PhongTessStrength;Phong Tess Strength;27;0;Create;True;0;0;0;True;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;201;-1312,-6592;Inherit;True;Property;_EdgeSize;Size;12;0;Create;False;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;438;-1312,-6816;Inherit;True;Property;_On;On;10;2;[Header];[ToggleUI];Create;True;1;Edge (Outline);0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;519;128,-1824;Inherit;False;Property;_Fog;Fog;25;0;Create;True;0;0;0;True;0;False;1;1;1;True;_FOG_ON;Toggle;2;Key0;Key1;Create;False;False;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;370;64,-1664;Inherit;True;Property;_HDR;HDR;22;0;Create;True;0;0;0;False;0;False;1;1;1;1000;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;325;448,-1152;Inherit;False;323;myAlphaCutoff;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;518;208,-480;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StickyNoteNode;527;-1856,-2240;Inherit;False;482.8;209.6001;Bug;;1,0,0,1;Shader error in 'MMD Collection/URP/MMD - Tessellation (Amplify Shader Editor)': invalid subscript 'texcoord' at Editor).shader(824) (on d3d11)$$Bug reported: https://github.com/AmplifyCreations/AmplifyShaderEditor-Feedback/issues/379$;0;0
...
ASEEND*/
//CHKSM=04049FA6BF1148CC16F405731508EA8D5F346CC7