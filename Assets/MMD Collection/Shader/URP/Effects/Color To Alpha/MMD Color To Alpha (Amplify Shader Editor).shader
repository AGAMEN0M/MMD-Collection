	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float3 vertexValue = ( Status23_g61320 == (float)0 ? temp_cast_1 : ( _EdgeSize * input.normalOS ) );
			...
			) : SV_Target
			{
				...
				float4 temp_output_25_0_g61320 = _OutlineColor;
				...
				float3 Color = (temp_output_25_0_g61320).rgb;
				float Alpha = ( Status23_g61320 == (float)1 ? ( Sgurface248 == (float)0 ? (float)1 : saturate( temp_output_25_0_g61320.a ) ) : (float)0 );
		...
		Pass
		{
			...
			half4 CalculateShadowMask1_g61327( half2 LightmapUV )
			{
						 ...
						 ) : SV_Target
			{
				...
				float temp_output_23_0_g61319 = _SShad;
				float3 break10_g61317 = _ToonTone;
				float3 objToWorldDir5_g61315 = mul( GetObjectToWorldMatrix(), float4( input.ase_normal, 0.0 ) ).xyz;
				float3 normalizeResult3_g61315 = normalize( objToWorldDir5_g61315 );
				float3 normalizeResult2_g61315 = normalize( _MainLightPosition.xyz );
				float dotResult4_g61315 = dot( normalizeResult3_g61315 , normalizeResult2_g61315 );
				float temp_output_1_0_g61317 = ( ( break10_g61317.y * dotResult4_g61315 ) + break10_g61317.z );
				float localshadowAtten16_g61317 = ( 0.0 );
				float3 objToWorld8_g61317 = mul( GetObjectToWorldMatrix(), float4( input.ase_texcoord3.xyz, 1 ) ).xyz;
				float3 worldPos16_g61317 = objToWorld8_g61317;
				float OutputShadowAtten16_g61317 = 0.0;
				shadowAtten_float( worldPos16_g61317 , OutputShadowAtten16_g61317 );
				float temp_output_2_0_g61317 = ( break10_g61317.z + ( break10_g61317.x * ( OutputShadowAtten16_g61317 - 0.5 ) ) );
				float temp_output_555_22 = min( temp_output_1_0_g61317, temp_output_2_0_g61317 );
				float temp_output_21_0_g61319 = saturate( temp_output_555_22 );
				float2 appendResult11_g61319 = (float2(temp_output_21_0_g61319 , temp_output_21_0_g61319));
				float4 tex2DNode33_g61319 = tex2D( _ToonTex, ( temp_output_23_0_g61319 == (float)0 ? appendResult11_g61319 : float2( 0,0 ) ) );
				float temp_output_3_0_g61316 = ( temp_output_555_22 * 2.0 );
				float4 lerpResult9_g61319 = lerp( tex2DNode33_g61319 , float4( float3( 1, 1, 1 ) , 0.0 ) , saturate( ( ( temp_output_3_0_g61316 * temp_output_3_0_g61316 ) - 1.0 ) ));
				float locallightColor15_g61317 = ( 0.0 );
				float3 worldPos15_g61317 = objToWorld8_g61317;
				float3 OutputColor15_g61317 = float3( 0,0,0 );
				lightColor_float( worldPos15_g61317 , OutputColor15_g61317 );
				float3 temp_output_12_0_g61321 = OutputColor15_g61317;
				float3 temp_cast_5 = 0;
				float locallightmapCol11_g61321 = ( 0.0 );
				float2 lightmapUV11_g61321 = (input.ase_texcoord4.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float3 Output11_g61321 = float3( 0,0,0 );
				lightmapCol_float( lightmapUV11_g61321 , Output11_g61321 );
				#ifdef LIGHTMAP_ON
				float3 staticSwitch8_g61321 = ( ( temp_output_12_0_g61321 == temp_cast_5 ? ( Output11_g61321 * 2.0 ) : temp_output_12_0_g61321 ) + Output11_g61321 );
				#else
				float3 staticSwitch8_g61321 = temp_output_12_0_g61321;
				#endif
				half3 Global_Light_Scale139 = half3( 0.6, 0.6, 0.6 );
				float3 Light_Color25_g61323 = ( staticSwitch8_g61321 * Global_Light_Scale139 );
				...
				float3 objToWorldDir9_g61318 = mul( GetObjectToWorldMatrix(), float4( input.ase_normal, 0.0 ) ).xyz;
				float3 normalizeResult4_g61318 = normalize( objToWorldDir9_g61318 );
				float3 normalizeResult7_g61318 = normalize( ( _MainLightPosition.xyz + ViewDirWS ) );
				float dotResult1_g61318 = dot( normalizeResult4_g61318 , normalizeResult7_g61318 );
				...
				float3 WorldPosition288_g61325 = PositionWS;
				float3 WorldPosition337_g61325 = WorldPosition288_g61325;
				float2 ScreenUV286_g61325 = (ScreenPosNorm).xy;
				float2 ScreenUV337_g61325 = ScreenUV286_g61325;
				float3 objToWorldDir5_g61324 = mul( GetObjectToWorldMatrix(), float4( input.ase_normal, 0.0 ) ).xyz;
				float3 WorldNormal281_g61325 = objToWorldDir5_g61324;
				float3 WorldNormal337_g61325 = WorldNormal281_g61325;
				half2 LightmapUV1_g61327 = (input.ase_texcoord4.zw*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				half4 localCalculateShadowMask1_g61327 = CalculateShadowMask1_g61327( LightmapUV1_g61327 );
				float4 ShadowMask360_g61325 = localCalculateShadowMask1_g61327;
				float4 ShadowMask337_g61325 = ShadowMask360_g61325;
				float3 localAdditionalLightsLambertMask171x337_g61325 = AdditionalLightsLambertMask171x( WorldPosition337_g61325 , ScreenUV337_g61325 , WorldNormal337_g61325 , ShadowMask337_g61325 );
				float3 temp_output_13_0_g61324 = temp_output_549_0;
				float3 Additional_Lights268 = ( _MultipleLights == (float)1 ? ( localAdditionalLightsLambertMask171x337_g61325 + temp_output_13_0_g61324 ) : temp_output_13_0_g61324 );
				
				float Sgurface248 = _Surface;
				float Sub_Texture_Mask646 = tex2DNode10_g61277.a;
				...
				float3 Color = ( ( ( ( saturate( ( temp_cast_0 - ( _ShadowLum * ( temp_cast_1 - ( temp_output_23_0_g61319 == (float)0 ? tex2DNode33_g61319 : lerpResult9_g61319 ) ) ) ) ) * float4( Light_Color25_g61323 , 0.0 ) * lerpResult16_g61278 ) + ( ( pow( saturate( dotResult1_g61318 ) , max( _Shininess, 0.001 ) ) * _Specular * float4( Light_Color25_g61323 , 0.0 ) ) * _SpecularIntensity ) ) + ( lerpResult16_g61279 * float4( ( Additional_Lights268 * Ambient_Blend_Factor48 ) , 0.0 ) ) ) * _HDR ).rgb;
...
/*ASEBEGIN
Version=19907
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;610;-7680,-5056;Inherit;False;6561.605;4258.632;MMD Material Calculation;51;499;292;591;558;429;325;370;196;268;197;176;609;607;553;122;603;605;88;82;604;555;589;47;542;533;307;594;289;384;602;10;478;56;40;207;601;547;598;145;139;11;144;578;48;549;577;599;600;28;644;646;;0,1,0,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;620;-4224,-736;Inherit;False;2014.654;1472.632;Color To Alpha;19;622;621;640;650;639;638;641;651;642;16;636;637;643;649;647;635;633;634;645;;0,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;633;-3872,224;Inherit;True;Color To Alpha (Amplify Shader Editor);0;;61312;c56b444fd5d5e994bb6ccc7147b8541a;0;3;9;COLOR;0,0,0,0;False;10;COLOR;0,0,0,0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;574;-7328,-5664;Inherit;True;Alpha Clip Threshold (Amplify Shader Editor);-1;;61313;171eab994f1a2214cbab7964a5267fe1;0;2;7;FLOAT;0;False;6;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;533;-5472,-3680;Inherit;True;N dot L (Amplify Shader Editor);-1;;61315;96e0e28ec623e134ba66ab21882969ae;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;542;-4736,-4288;Inherit;True;Toon Shadow Mask (Amplify Shader Editor);-1;;61316;d4c61b1560e7f524485e042d9cbfa12f;0;1;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;555;-5152,-4032;Inherit;True;Light Calculation (Amplify Shader Editor);-1;;61317;af01f53e0d9e3474ca896a09a7abf366;0;2;19;FLOAT3;1,0.5,0.5;False;20;FLOAT;0;False;4;FLOAT;0;FLOAT;17;FLOAT;22;FLOAT3;18
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;553;-3584,-2816;Inherit;True;Blinn Phong Specular (Amplify Shader Editor);-1;;61318;0d9f1343fd295844e9ab4da8a467178a;0;1;14;FLOAT;50;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;589;-4192,-4672;Inherit;True;Toon Ramp Shadow (Amplify Shader Editor);-1;;61319;12d15763f50b8154696c9a4946cb6844;0;5;23;FLOAT;1;False;25;FLOAT;1.5;False;26;SAMPLER2D;0;False;29;FLOAT;0;False;22;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;611;-6048,-5632;Inherit;True;Outline Control (Amplify Shader Editor);-1;;61320;9b89aaf063c597e47936ca5e506b1b8f;0;4;28;FLOAT;0;False;32;FLOAT;0;False;25;COLOR;0,0,0,1;False;24;FLOAT;0;False;3;FLOAT3;29;FLOAT;0;FLOAT3;30
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;616;-4736,-3904;Inherit;True;Baked LightMap Contribution (Amplify Shader Editor);-1;;61321;b0308fde66b3df54883fd907b3a91063;0;1;12;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;617;-2592,-2816;Inherit;True;Final Lighting Composition (Amplify Shader Editor);-1;;61323;cc1fc2fda045d8b4aa23e1107f6b1fd6;0;11;29;FLOAT3;0.6,0.6,0.6;False;31;COLOR;0,0,0,0;False;28;FLOAT3;0,0,0;False;37;COLOR;0,0,0,0;False;32;COLOR;0,0,0,0;False;33;FLOAT;0;False;34;COLOR;0,0,0,0;False;35;FLOAT;1;False;38;FLOAT3;0,0,0;False;39;FLOAT3;0,0,0;False;41;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;619;-5472,-3424;Inherit;True;Additional Lights (Amplify Shader Editor);-1;;61324;0903e89e038650f4c8f73f079567a741;0;2;15;FLOAT;1;False;13;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;646;0;594;37
WireConnection;289;0;207;0
WireConnection;634;0;645;0
WireConnection;633;9;645;0
WireConnection;633;10;621;0
WireConnection;633;8;622;0
...
ASEEND*/
//CHKSM=839AB6710819FE09BBCAA4F8D38A48A8B2AA6C98