	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float3 localvLight12 = vLight( normal12 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = localvLight12;
				float Alpha = 1;
...
Node;AmplifyShaderEditor.CustomExpressionNode;12;-224,0;Float;False;return SampleSH(normal)@$;3;Create;1;True;normal;FLOAT3;0,0,0;In;;Inherit;False;vLight;False;False;0;;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=59DCA152AF96962CFFF084267893BC251ABAC126