...
public class MMDMaterialCustomInspector_ShaderGraph : ShaderGUI
{
    ...
    private void RenderCustomMaterialInspector()
    {
        ...
        RenderDropdownProperty("_EFFECTS", "Effects:", new string[] { "- Disabled", "x Multi-Sphere", "+ Add-Sphere", "Sub-Tex" }, new float[] { 0, 2, 1, 3 }, 100, 150, false, new string[] { "_EFFECTS_DISABLED", "_EFFECTS_MULTI_SPHERE", "_EFFECTS_ADD_SPHERE", "_EFFECTS_DISABLED" });
    ...
    private void RenderDropdownProperty(string propertyName, string label, string[] displayOptions, float[] numberOptions, float space, float dropdownSpace, bool expand = false, string[] keywordOptions = null)
    {
