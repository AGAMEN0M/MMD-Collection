...
namespace MMDCollection.Editor
{
    ...
    /// </summary>
    public class MaterialShaderConverter
    {
        ...
        {
            /// <summary>Standard URP shader without tessellation or special passes.</summary>
            Default,

            /// <summary>Shader with tessellation support.</summary>
            Tessellation,

            /// <summary>Minimal shader, used for dummy materials.</summary>
            Empty,

            /// <summary>Multi-pass shader with 4 outline layers.</summary>
            FourLayers,

            /// <summary>Multi-pass shader with 8 outline layers.</summary>
            EightLayers,

            /// <summary>Shader variant that disables shadow casting.</summary>
            NoShadow,

            /// <summary>Shader variant with tessellation but no shadow casting.</summary>
            NoShadowAndTessellation
        }
        ...
        /// <summary>
        /// Reflection method for fetching global shader keywords. Cached for performance.
        /// </summary>
        ...
        private static readonly Dictionary<string, (string newShader, bool transparent, bool outline, bool twoSide, bool gShad, ShaderModel model)> shaderMap = new()
        {
            ...
            { "MMD4Mecanim/MMDLit-NEXTEdge-Pass4", ("MMD Collection/URP/MMD - Multiple Outline (Shader Graph)", false,false,false,false, ShaderModel.FourLayers) },
            { "MMD4Mecanim/MMDLit-NEXTEdge-Pass8", ("MMD Collection/URP/MMD - Multiple Outline (Shader Graph)", false,false,false,false, ShaderModel.EightLayers) },
        ...
        /// </summary>
        [MenuItem("Assets/Tools/MMD Collection/Convert Material Shader (MMD4Mecanim)")]
        ...
        /// </summary>
        /// <param name="material">Target material that will be converted.</param>
        /// <param name="mapping">Shader conversion mapping containing shader path, rendering flags, and shader model configuration.</param>
        ...
        /// </summary>
        /// <param name="material">Target material that will receive the converted shader.</param>
        /// <param name="newShaderName">Name of the new shader that will be assigned to the material.</param>
        /// <param name="transparent">Indicates whether the material should use transparent rendering.</param>
        /// <param name="outline">Indicates whether outline rendering should be enabled.</param>
        /// <param name="twoSide">Indicates whether double-sided rendering should be enabled.</param>
        /// <param name="gShad">Indicates whether global shadow casting should be enabled.</param>
        /// <param name="model">Shader model variant used during the conversion process.</param>
        ...
        /// </summary>
        /// <param name="material">Target material that will receive the empty shader configuration.</param>
        /// <param name="newShaderName">Name of the shader that will be assigned to the material.</param>
        ...
        /// </summary>
        /// <param name="material">Target material that will receive the multi-pass shader.</param>
        /// <param name="newShaderName">Name of the shader that will be assigned to the material.</param>
        /// <param name="layers">Shader model that defines the number of outline layers to use.</param>
        ...
        /// </summary>
        /// <param name="value">Original render queue value.</param>
        /// <returns>Adjusted render queue value configured for transparent rendering when applicable.</returns>
        ...
        /// </summary>
        /// <param name="material">Material whose invalid serialized properties and keywords will be removed.</param>
        ...
        /// </summary>
        /// <param name="properties">Serialized property collection that will be validated and cleaned.</param>
        /// <param name="validProperties">Collection containing all valid shader property names.</param>
        ...
        /// </summary>
        /// <param name="material">Material whose invalid shader keywords will be removed.</param>
        /// <param name="shader">Shader used to validate the material keywords.</param>
