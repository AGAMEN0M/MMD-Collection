...
public class MMDNormalAndHeightTessellationInspector_AmplifyShaderEditor : ShaderGUI
{
    ...
    private void RenderCustomMaterialInspector()
    {
        ...
        GUILayout.Label("Simulator Normal Map Settings", EditorStyles.boldLabel);
        EditorGUILayout.BeginHorizontal();
        CustomInspectorUtilityEditor.RenderUIToggle(materialProperties, "_SimulatorNormalMap", "Normal Map:", 75f);
        GUILayout.Space(-145f);
        CustomInspectorUtilityEditor.RenderFloatProperty(materialProperties, "_BumpScale", "Normal Scale:", 85f);
        EditorGUILayout.EndHorizontal();
        CustomInspectorUtilityEditor.RenderTextureProperty(materialProperties, "_NormalMap", "Normal Map:");
        GUILayout.Space(10f);

        GUILayout.Label("Simulator Height Map Settings", EditorStyles.boldLabel);
        EditorGUILayout.BeginHorizontal();
        CustomInspectorUtilityEditor.RenderUIToggle(materialProperties, "_SimulatorHeightMap", "Height Map:", 75f);
        GUILayout.Space(10f);
        CustomInspectorUtilityEditor.RenderSliderFloatProperty(materialProperties, "_Parallax", "Parallax:", 0.005f, 0.08f, 60f, 230f);
        EditorGUILayout.EndHorizontal();
        CustomInspectorUtilityEditor.RenderTextureProperty(materialProperties, "_ParallaxMap", "Height Map:");
        GUILayout.Space(10f);
