 ...
 *              variant with Color-to-Alpha support.
...
{
    public class MMDMaterial_ASE_CA : MMDMaterialCustomInspectorBase
    {
        #region === Inspector UI ===
        ...
        protected override void DrawUI()
        {
            ...
            HeaderGroupGUI.DrawGroup(new GUIContent("Color to Alpha Settings", "Converts a specific color from the texture into transparency."), () =>
            {
                ColorProperty(new GUIContent("Color to Alpha", "Defines the color that will be converted into transparent pixels."), properties, "_ColortoAlpha");
                FloatSliderProperty(new GUIContent("Color Tolerance", "Controls how close a pixel color must be to be considered transparent."), properties, "_ColorTolerance", 0f, 1f);
            });
        }
